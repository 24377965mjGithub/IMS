            ...
            <ul>
                ...
                <li class="nav-link product-dropdown">
                    ...
                    <ul class="product-dropdown-items">
                        ...
                        <a href="{{ url('/productouts') }}" class="nav-link active">
            ...
            <div class="container-fluid">
                ...
                <div class="main-box">
                    <div class="table-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 buttons">
                                <a href="{{ url('/export-product-outs') }}">
                    ...
                    <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                @foreach ($products as $product)
                                                    @if ($productOut->productId == $product->id)
                                                        ...
                                                        {{-- discount in percent --}}
                                                        <td><b class="font-weight-bold text-secondary">{{ App\Models\CustomerType::where('id', $productOut->customersTypeId)->value('discountPercentage') }}%</b></td>
                                                        {{-- total price --}}
                                                        <td><b class="font-weight-bold">₱ {{ $productOut->quantity * $product->productPrice }}</b></td>
                                                        {{-- discounted price TOTAL PRICE - DISCOUNT --}}
                                                        {{-- check if has discount --}}
                                                        @if (!App\Models\CustomerType::where('id', $productOut->customersTypeId)->value('discountPercentage'))
                                                            <td><b class="font-weight-bold text-success">₱ {{ $productOut->quantity * $product->productPrice }}</b></td>
                                                        @else
                                                            <td><b class="font-weight-bold text-success">₱ {{ $productOut->quantity * $product->productPrice - $productOut->quantity * $product->productPrice * floatval(0..".".App\Models\CustomerType::where('id', $productOut->customersTypeId)->value('discountPercentage')) }}</b></td>
                                                        @endif
                                                    @endif
                                                @endforeach
                        ...
                        {{ $productOuts->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
