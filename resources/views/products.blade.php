                ...
                <div class="main-box">
                    <div class="table-heading">
                        ...
                        @if (session('productUploaded'))
                            <p class="alert alert-success">{{ session('productUploaded') }}</p>
                        @endif
                        @if (session('productUpadated'))
                            <p class="alert alert-success">{{ session('productUpadated') }}</p>
                        @endif
                        @if (session('productImgUploaded'))
                            <p class="alert alert-success">{{ session('productImgUploaded') }}</p>
                        @endif
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 buttons">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="productCategoryId" id="" class="form-control productCategorySelect">
                                                                @foreach ($productCategories as $productCategory)
                                                                    <option value="{{ $productCategory->id }}">{{ $productCategory->categoryName }}</option>
                                                                @endforeach
                                                            </select>
                                                            <p class="alert alert-white" style="font-size: 12px; cursor: pointer" data-toggle="modal" data-target="#productcategory"><i class="fa fa-plus"></i> Add New Category</p>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label for="">Supplier</label>
                                                            <select name="suppliersId" id="" class="form-control suppliersSelect">
                                                                @foreach ($suppliers as $supplier)
                                                                    <option value="{{ $supplier->id }}">{{ $supplier->suppliersName }}</option>
                                                                @endforeach
                                                            </select>
                                                            <p class="alert alert-white" style="font-size: 12px; cursor: pointer" data-toggle="modal" data-target="#supplier"><i class="fa fa-plus"></i> Add New Supplier</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="productUnit" id="" class="form-control">
                                ...
                                <div class="modal fade" id="productcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                <div class="msg" style="text-align: left"></div>
                                                <div class="form-group">
                                                    <label for="">Category Name</label>
                                                    <input type="text" name="categoryName" placeholder="Category Name..." class="form-control categoryName">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Category Description</label>
                                                    <textarea name="categoryDescription" class="form-control categoryDescription" cols="30" rows="10"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Packaging</label>
                                                    <input type="text" name="categoryPackaging" placeholder="wholesale..." class="form-control categoryPackaging">
                                                </div>
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-success form-control saveCategory">Save <i class="fa fa-check"></i></button>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="suppliersName" placeholder="Supplier 1..." class="form-control suppliersName">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Supplier Phone Number</label>
                                                    <input type="number" name="suppliersPhoneNumber" placeholder="09xxx..." class="form-control suppliersPhoneNumber">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Supplier Email</label>
                                                    <input type="email" name="suppliersEmail" placeholder="supplier@gmail.com" class="form-control suppliersEmail">
                                                </div>
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-success form-control saveSupplier">Save <i class="fa fa-check"></i></button>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="modal-footer">
                                    ...
                                    <tr class="search_div">
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="editproduct{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit {{ $product->productName }}</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ url('/saveeditproduct/'.$product->id) }}" method="post">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="">Product Name</label>
                                                                        ...
                                                                        <select name="suppliersId" id="" class="form-control">
                                                                            @foreach ($suppliers as $supplier)
                                                                                @if ($product->suppliersId == $supplier->id)
                                                                                    <option value="{{ $supplier->id }}" selected>{{ $supplier->suppliersName }}</option>
                                                                                @else
                                                                                    <option value="{{ $supplier->id }}">{{ $supplier->suppliersName }}</option>
                                                                                @endif
                                                                            @endforeach
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">Bar Code</label>
                                                                <input type="text" class="form-control" placeholder="123-123-123" name="productBarCode" value="{{ $product->productBarCode }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Description</label>
                                                                <textarea name="productDescription" id="" cols="30" rows="10" class="form-control">{{ $product->productDescription }}</textarea>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <label for="">Quantity</label>
                                                                        <input type="number" class="form-control" placeholder="0" name="productQuantity" value="{{ $product->productQuantity }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <label for="">Unit</label>
                                                                        <select name="productUnit" id="" class="form-control" value="{{ $product->productUnit }}">
                                                                            @foreach ($units as $unit)
                                                                                @if ($unit === $product->productUnit)
                                            ...
                                            <div class="modal fade" id="changeProductImage{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel">Change Image for <b>{{ $product->productName }}</b></h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ url('/saveeditproductimg/'.$product->id) }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="">Image</label>
                                                                <input type="file" id="file-ip-1" accept="image/*" name="productImage" class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-success form-control">Save <i class="fa fa-check"></i></button>
                                                            </div>
                                            ...
                                            <div class="modal fade" id="deleteProduct{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel">Delete <b>{{ $product->productName }}?</b></h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>
                                                            <p>
                                                                Do you want to remove <b>{{ $product->productName }}</b>? All data associated with this product will be lost. This action cannot be undone.
                                                            </p>
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                            ...
                                            <div class="modal fade" id="in{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Add quantity for <b>{{ $product->productName }}</b></h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        {{-- component quantity form --}}
                                                        @livewire('product-in-form', [
                                                  ...
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ url('/saveproductout', [
                                                            ...
                                                            {{-- <div class="form-group">
                                                                <label for="" class="text-success">Voucher (optional)</label>
