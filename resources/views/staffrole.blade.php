                ...
                @if (Auth::user()->role == 1)
                    <li class="nav-link staff-dropdown">
                        ...
                        <ul class="staffs-dropdown-items">
                            ...
                            <a href="{{ url('/staffroles') }}" class="nav-link active">
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 main">
            <div class="container-fluid">
                @if (request()->get('search'))
                    <h1 class="page-title-h1">Staff Roles</h1>
                    <p class="py-3">
                        <b><a href="{{ url('/staffroles') }}" style="color: blue; text-decoration: none;">Show all Staff roles</a> | Showing results for "{{ request()->get('search') }}".</b>
                    </p>
                @else
                    <h1 class="page-title-h1">Staff Roles</h1>
                @endif
                ...
                <div class="main-box">
                    <div class="table-heading">
                        ...
                        @if (session('roleNameSave'))
                            <p class="alert alert-success">{{ session('roleNameSave') }}</p>
                        @endif
                        @if (session('roleNameEditSave'))
                            <p class="alert alert-success">{{ session('roleNameEditSave') }}</p>
                        @endif
                        @if (session('roleDeleted'))
                            <p class="alert alert-success">{{ session('roleDeleted') }}</p>
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 buttons">
                                ...
                                <button class="btn btn-primary new-btn" data-toggle="modal" data-target="#product">New Role</button>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/saverole') }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Role Name..." name="roleName">
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#edit{{ $role->id }}">Edit</a>
                                                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#delete{{ $role->id }}">Delete</a>
                                            </div>
                                            ...
                                            <div class="modal fade" id="edit{{ $role->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Edit {{ $role->roleName }}</b></h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ url('/saveeditrole/'.$role->id) }}" method="post">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="">Edit Role</label>
                                                                <input type="text" class="form-control" name="roleName" id="" placeholder="Edit role..." value="{{ $role->roleName }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <button type="submit" class="form-control btn btn-info"><i class="fa fa-check"></i> Save</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="modal-footer">
                                            ...
                                            <div class="modal fade" id="delete{{ $role->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Delete {{ $role->roleName }}?</b></h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>
                                                            Do you want to remove <b>{{ $role->roleName }}</b>? All data associated with this record will be lost. This action cannot be undone.
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="{{ url('/deleterole', ['id' => $role->id]) }}">
