                ...
                @if (Auth::user()->role == 1)
                    <li class="nav-link staff-dropdown">
                        ...
                        <ul class="staffs-dropdown-items">
                            <a href="{{ url('/staffs') }}" class="nav-link active">
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 main">
            <div class="container-fluid">
                @if (request()->get('search'))
                    <h1 class="page-title-h1">Staffs</h1>
                    <p class="py-3">
                        <b><a href="{{ url('/staffs') }}" style="color: blue; text-decoration: none;">Show all Staffs</a> | Showing results for "{{ request()->get('search') }}".</b>
                    </p>
                @else
                    <h1 class="page-title-h1">Staffs</h1>
                @endif
                ...
                <div class="main-box">
                    <div class="table-heading">
                        ...
                        @endif
                        {{-- added --}}
                        @if (session('staffAddedSuccessfully'))
                            <p class="alert alert-success">{{ session('staffAddedSuccessfully') }}</p>
                        @endif
                        {{-- updated name --}}
                        @if (session('staffUpdatedSuccessfully'))
                            <p class="alert alert-success">{{ session('staffUpdatedSuccessfully') }}</p>
                        @endif
                        {{-- updated email --}}
                        @if (session('staffEmailUpdatedSuccessfully'))
                            <p class="alert alert-success">{{ session('staffEmailUpdatedSuccessfully') }}</p>
                        @endif
                        {{-- updated phone --}}
                        @if (session('staffPhoneNumberUpdatedSuccessfully'))
                        <p class="alert alert-success">{{ session('staffPhoneNumberUpdatedSuccessfully') }}</p>
                        @endif
                        {{-- updated password --}}
                        @if (session('staffPasswordUpdatedSuccessfully'))
                        <p class="alert alert-success">{{ session('staffPasswordUpdatedSuccessfully') }}</p>
                        @endif
                        {{-- updated password --}}
                        @if (session('staffPasswordNotMatch'))
                        <p class="alert alert-danger">{{ session('staffPasswordNotMatch') }}</p>
                        @endif
                        {{-- updated password --}}
                        @if (session('staffPasswordIncorrect'))
                        <p class="alert alert-danger">{{ session('staffPasswordIncorrect') }}</p>
                        @endif


                        @if (session('staffTerminated'))
                            <p class="alert alert-success">{{ session('staffTerminated') }}</p>
                        @endif
                        @if (session('adminTerminateError'))
                            <p class="alert alert-info">{{ session('adminTerminateError') }}</p>
                        @endif
                                ...
                                <div class="modal fade" id="staff" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ url('/savestaff') }}">
                                                @csrf
                    ...
                    <div class="table-responsive">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#editName{{ $staff->id }}">Edit Name</a>
                                                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#editEmail{{ $staff->id }}">Change Email</a>
                                                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#editPhone{{ $staff->id }}">Change Phone Number</a>
                                                    <a class="dropdown-item" href="" data-toggle="modal" data-target="#editPassword{{ $staff->id }}">Change Password</a>
                                                    <a class="dropdown-item text-danger" href="" data-toggle="modal" data-target="#terminate{{ $staff->id }}">Terminate</a>
                                                </div>
                                            </div>

                                            {{-- edit staff name modal modal --}}

                                            <div class="modal fade" id="editName{{ $staff->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit {{ $staff->firstname }}</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ url('/savestaffname/'.$staff->id) }}">
                                                            @csrf
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ $staff->firstname }}" required autocomplete="firstname" autofocus>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="middlename" type="text" class="form-control @error('middlename') is-invalid @enderror" name="middlename" value="{{ $staff->middlename }}" required autocomplete="middlename" autofocus>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ $staff->lastname }}" required autocomplete="lastname" autofocus>
                                            ...
                                            {{-- end edit staff name modal --}}

                                            {{-- edit staff email modal modal --}}

                                            <div class="modal fade" id="editEmail{{ $staff->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit {{ $staff->firstname }}'s email.</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ url('/savestaffemail/'.$staff->id) }}">
                                                            @csrf
                                            ...
                                            {{-- end edit staff email modal --}}

                                            {{-- edit staff phone modal modal --}}

                                            <div class="modal fade" id="editPhone{{ $staff->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit {{ $staff->firstname }}'s phone number.</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ url('/savestaffphone/'.$staff->id) }}">
                                                            @csrf
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="phonenumber" type="number" class="form-control @error('phonenumber') is-invalid @enderror" name="phonenumber" value="{{ $staff->phonenumber }}" required autocomplete="phonenumber" autofocus>
                                            ...
                                            {{-- end edit staff phone modal --}}

                                            {{-- edit staff password modal --}}

                                            <div class="modal fade" id="editPassword{{ $staff->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit {{ $staff->firstname }}'s password.</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ url('/savestaffpassword/'.$staff->id) }}">
                                                            @csrf
                                            ...
                                            {{-- edit terminate modal --}}

                                            <div class="modal fade" id="terminate{{ $staff->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Terminate {{ $staff->firstname }}?</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p>
                                                            Do you want to terminate <b>{{ $staff->firstname }} {{ $staff->middlename }} {{ $staff->lastname }}</b>? All data associated with this record will be lost. This action cannot be undone.
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="{{ url('/terminatestaff', ['id' => $staff->id]) }}">
                        ...
                        {{-- {{ $productIns->links('pagination::bootstrap-5') }} --}}
                    </div>
                </div>
            </div>
        </div>
