...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 main" id="main">
            <div class="container-fluid">
                @if (request()->get('search'))
                    <h1 class="page-title-h1">Suppliers</h1>
                    <p class="py-3">
                        <b><a href="{{ url('/suppliers') }}" style="color: blue; text-decoration: none;">Show all suppliers</a> | Showing results for "{{ request()->get('search') }}"</b>
                    </p>
                @endif
                {{-- <h1 class="page-title-h1">Suppliers</h1> --}}
                ...
                <div class="main-box">
                    <div class="table-heading">
                        ...
                        @if (session('newSupplier'))
                            <p class="alert alert-success">{{ session('newSupplier') }}</p>
                        @endif
                        @if (session('edittedSupplier'))
                            <p class="alert alert-success">{{ session('edittedSupplier') }}</p>
                        @endif
                        @if (session('deletedSupplier'))
                            <p class="alert alert-success">{{ session('deletedSupplier') }}</p>
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 buttons">
                                ...
                                <button class="btn btn-primary new-btn" data-toggle="modal" data-target="#supplier">New Supplier</button>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/addsupplier') }}" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="suppliersName" placeholder="Supplier 1..." class="form-control supplierName">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Supplier Phone Number</label>
                                                    <input type="number" name="suppliersPhoneNumber" placeholder="09xxx..." class="form-control supplierPhone">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Supplier Email</label>
                                                    <input type="email" name="suppliersEmail" placeholder="supplier@gmail.com" class="form-control supplierEmail">
                                                </div>
                                                <div class="form-group">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                <th scope="col">
                                    <input type="checkbox" name="" id="" class="checkallsuppliers">
                                    <i class="fa fa-trash delSupplier"></i>
                                </th>
                                <th scope="col">Supplier Name</th>
                                <th scope="col">Supplier Phone Number</th>
                                <th scope="col">Supplier Email</th>
                            </thead>
                            <tbody class="append-supplier">
                                ...
                                @foreach ($suppliers as $supplier)
                                    <tr>
                                        <th scope="row">
                                            <input type="checkbox" name="" id="" class="checksuppliers" data-id="{{ $supplier->id }}">
                                        </th>
                                        <td>{{ $supplier->suppliersName }}</td>
                                        <td>{{ $supplier->suppliersPhoneNumber }}</td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#supplierEdit{{ $supplier->id }}">Edit</a>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#supplierdelete{{ $supplier->id }}">Remove</a>
                                            </div>

                                            <!------------------------------------- EDIT MODAL --------------------------------------------->

                                            <div class="modal fade" id="supplierEdit{{ $supplier->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Edit {{ $supplier->suppliersName }}</h5>
                                                        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="{{ url('/savesupplier', ['id'=> $supplier->id]) }}" method="post">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="">Supplier Name</label>
                                                                <input type="text" name="suppliersName" placeholder="Supplier 1..." class="form-control editSupplierName" value="{{ $supplier->suppliersName }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Supplier Phone Number</label>
                                                                <input type="number" name="suppliersPhoneNumber" placeholder="09xxx..." class="form-control editSupplierPhone" value="{{ $supplier->suppliersPhoneNumber }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Supplier Email</label>
                                                                <input type="email" name="suppliersEmail" placeholder="supplier@gmail.com" class="form-control editSupplierEmail" value="{{ $supplier->suppliersEmail }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <button type="submit" class="btn btn-success form-control" data-id="">Save <i class="fa fa-check"></i></button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="modal-footer">
                                            ...
                                            <div class="modal fade" id="supplierdelete{{ $supplier->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel">Remove <b>{{ $supplier->suppliersName }}</b></h5>
                                                    </div>
                                                    <div class="modal-body">
                                                      <p>
                                                        Do you want to remove <b>{{ $supplier->suppliersName }}</b>? This action cannot be undone.
                                                      </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="{{ url('/deletesupplier', ['id' => $supplier->id]) }}">
